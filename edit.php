...
class Users{
    ...
    function get_form_data($data){
        $updatequery = "UPDATE users SET name='".$data['name']."', email='".$data['email']."', address='".$data['address']."', phone='".$data['phone']."' WHERE id=".$data['uid'];
        $runQuery = mysqli_query($this->conn, $updatequery);
    }
